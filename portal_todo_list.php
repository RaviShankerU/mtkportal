 ...
 */
    ...
    class portal_todo_listPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Portal Todo List');
            $this->SetMenuLabel('Outstanding Tasks');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('portal_todo_list_id', true, true, true),
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'created_by = \'%CURRENT_USER_NAME%\''));
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'portal_todo_list_id', 'portal_todo_list_id', 'Portal Todo List Id'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('created_date', 'created_date', 'Created Date', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
    ...
    try
    {
        $Page = new portal_todo_listPage("portal_todo_list", "portal_todo_list.php", GetCurrentUserPermissionsForPage("portal_todo_list"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("portal_todo_list"));
