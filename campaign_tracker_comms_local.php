 ...
 */
    ...
    class campaign_tracker_comms_localPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('email_name');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('campaign_tracker_comms_local_email_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('campaign_tracker_comms_local_campaign_description_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextAreaEdit('email_name_edit', 50, 8);
            ...
            //
            $editor = new TextEdit('campaign_utm_id_edit');
            $editColumn = new CustomEditColumn('Campaign Utm Id', 'campaign_utm_id', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('email_name', 'email_name', 'Email Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'campaign_tracker_comms_local_email_name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('campaign_description', 'campaign_description', 'Campaign Description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'campaign_tracker_comms_local_campaign_description_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
        }
