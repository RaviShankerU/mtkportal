 ...
 */
    ...
    class campaign_tracker_partnerPage extends Page
    {
        ...
        protected function CreateGrid()
        {
            ...
            $this->setDescription('<div class="mark-media mark-position-relative">
                          <div class="mark-bd-placeholder-img mr-3"><img src="apps/icons/partner-color.png" width="80" height="79"></div>
    ...
    try
    {
        $Page = new campaign_tracker_partnerPage("campaign_tracker_partner", "campaign_tracker_partner.php", GetCurrentUserPermissionsForPage("campaign_tracker_partner"), 'UTF-8');
