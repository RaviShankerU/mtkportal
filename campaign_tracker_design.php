    ...
    class campaign_tracker_designPage extends Page
    {
        ...
        protected function CreateGrid()
        {
            ...
            $this->setDescription('<div class="mark-media mark-position-relative">
                          <div class="mark-bd-placeholder-img mr-3"><img src="http://mktportal.mscsoftware.com/icons/design-color.png" width="80" height="79"></div>
                          <div class="mark-media-body">
                            ...
                            <a href="/apps/website_listing.php" class="stretched-link">View Live Lists</a>
                          </div>
                        </div>');
